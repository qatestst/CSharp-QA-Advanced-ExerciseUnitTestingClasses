...
public class VehicleTests
{
    ...
    [Test]
    public void Test_AddAndGetCatalogue_ReturnsSortedCatalogueWhenOnlyCarsAreGiven()
    {
        // Arrange
        Vehicles vehicles = new Vehicles();
        string[] input =
    ...
    [Test]
    public void Test_AddAndGetCatalogue_ReturnsSortedCatalogueWhenOnlyTrucksAreGiven()
    {
        // Arrange
        Vehicles vehicles = new Vehicles();
        string[] input =
